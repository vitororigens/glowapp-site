const BannerFour = () => {
    return (
      <div className="px-4 py-12 md:px-6 md:py-20 bg-gray-100 overflow-hidden">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-8 flex flex-col md:flex-row gap-6 justify-center">
            <div className="card bg-pink-500 flex justify-center items-center text-white text-base md:text-lg font-bold rounded-2xl px-6 py-4 md:w-1/3">
              Armazenamento completo dos dados de cada cliente
            </div>
            <div className="card bg-blue-600 flex justify-center items-center text-white text-base md:text-lg font-bold rounded-2xl px-6 py-4 md:w-1/3">
