          ...
          <div className="col-lg-6 col-md-12 col-sm-12 rounded-3 flex flex-col justify-center items-start">
            ...
            <div className="flex space-x-4 mt-4">
              <motion.a
                ...
                whileHover="hover"
              >
                <img src="/img/resource/app-store.png" className='w-64' alt="Button loja Apple store" />
              </motion.a>
              <motion.a
                ...
                whileHover="hover"
              >
                <img src="/img/resource/play-store.png" className='w-64' alt="Button loja Play store" />
              </motion.a>
            </div>
          </div>
