    ...
    <S.Banner>
      <S.BannerContainer>
        ...
        <S.BannerContentInner>
          ...
          <S.BannerText>
          Transforme a forma como você gerencia sua rotina com o aplicativo ideal para profissionais de estética. Agende atendimentos, organize seus serviços, controle suas finanças, e gerencie sua equipe com eficiência. Capture fotos de antes e depois, mantenha uma galeria exclusiva e compartilhe nas redes sociais com facilidade. Tudo o que você precisa para otimizar seu trabalho e conquistar seus clientes em um só lugar.
          </S.BannerText>
          <S.ButtonWrapper>
            <button
              onClick={() => {
